...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        if (stringHasValue(introspectedTable.getSearchRecordType())) {
            FullyQualifiedJavaType fqjt = new FullyQualifiedJavaType(
                    introspectedTable.getSearchRecordType());
            interfaze.addImportedType(fqjt);
        }
        commentGenerator.addModelClassComment(interfaze, introspectedTable);
        ...
        addSelectByModelMethod(interfaze);
    ...
    protected void addSelectByModelMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateSelectByModel()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new SelectByModelMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
